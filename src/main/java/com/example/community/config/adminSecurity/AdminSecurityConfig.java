...
public class AdminSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.antMatcher("/admin/**")
                ...
                .permitAll()
                .and()
                .csrf().ignoringAntMatchers("/admin/notice/delete/**","/admin/accountManage/unblock","/admin/guestBook/**","/admin/postDelete/**","/admin/commentDelete/**","/admin/forbiddenWord/delete/**");
    }
